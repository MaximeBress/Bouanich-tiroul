...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by JardiWinery
	 * @var $inverse	- added by JardiWinery
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by JardiWinery:
	// Color scheme
	if ($scheme && !jardiwinery_param_is_off($scheme) && !jardiwinery_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !jardiwinery_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add JardiWinery color scheme in the row
	if ($scheme && !jardiwinery_param_is_off($scheme) && !jardiwinery_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
