...
if (is_admin()) {
	...
	if ( !function_exists( 'jardiwinery_admin_load_scripts' ) ) {
		function jardiwinery_admin_load_scripts() {
			jardiwinery_enqueue_script( 'jardiwinery-debug-script', jardiwinery_get_file_url('js/core.debug.js'), array('jquery'), null, true );
			jardiwinery_enqueue_style( 'jardiwinery-admin-style', jardiwinery_get_file_url('css/core.admin.css'), array(), null );
			jardiwinery_enqueue_script( 'jardiwinery-admin-script', jardiwinery_get_file_url('js/core.admin.js'), array('jquery'), null, true );
			if (jardiwinery_strpos($_SERVER['REQUEST_URI'], 'widgets.php')!==false) {
				jardiwinery_enqueue_style( 'jardiwinery-fontello-style', jardiwinery_get_file_url('css/fontello-admin/css/fontello-admin.css'), array(), null );
				jardiwinery_enqueue_style( 'jardiwinery-animations-style', jardiwinery_get_file_url('css/fontello-admin/css/animation.css'), array(), null );
			}
		}
	}
	...
	require_once trailingslashit( get_template_directory() ) . JARDIWINERY_FW_DIR . '/lib/tgm/class-tgm-plugin-activation.php';

	require_once trailingslashit( get_template_directory() ) . JARDIWINERY_FW_DIR . '/tools/po_composer/po_composer.php';
}
