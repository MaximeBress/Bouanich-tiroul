...
class jardiwinery_widget_banner extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div class="widget_banner_inner">
			...
			if ($banner_code!='') {
				echo force_balance_tags(jardiwinery_substitute_all($banner_code));
			}
			?>
		</div>
		<?php
	...
	function form( $instance ) {
		...
		<p>
            ...
            <?php
			echo trim(jardiwinery_show_custom_field($this->get_field_id( 'banner_media' ), array('type'=>'mediamanager', 'media_field_id'=>$this->get_field_id( 'banner_image' )), null));
			if ($banner_image) {
			?>
