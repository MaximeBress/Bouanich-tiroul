...
if ( !function_exists( 'jardiwinery_template_testimonials_2_theme_setup' ) ) {
	add_action( 'jardiwinery_action_before_init_theme', 'jardiwinery_template_testimonials_2_theme_setup', 1 );
	function jardiwinery_template_testimonials_2_theme_setup() {
		jardiwinery_add_template(array(
			'layout' => 'testimonials-2',
			'template' => 'testimonials-2',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 2/', 'jardiwinery')
		));
	}
}

// Template output
if ( !function_exists( 'jardiwinery_template_testimonials_2_output' ) ) {
	function jardiwinery_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
