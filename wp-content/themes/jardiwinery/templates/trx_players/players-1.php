...
if ( !function_exists( 'jardiwinery_template_players_1_theme_setup' ) ) {
	add_action( 'jardiwinery_action_before_init_theme', 'jardiwinery_template_players_1_theme_setup', 1 );
	function jardiwinery_template_players_1_theme_setup() { 
		jardiwinery_add_template(array(
			'layout' => 'players-1',
			'template' => 'players-1',
			'mode'   => 'players',
			'title'  => esc_html__('Players /Style 1/', 'jardiwinery'),
...
// Template output
if ( !function_exists( 'jardiwinery_template_players_1_output' ) ) {
	function jardiwinery_template_players_1_output($post_options, $post_data) { 
		$show_title = true;
