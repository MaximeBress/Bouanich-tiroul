...
if ( !function_exists( 'jardiwinery_template_related_theme_setup' ) ) {
	add_action( 'jardiwinery_action_before_init_theme', 'jardiwinery_template_related_theme_setup', 1 );
	function jardiwinery_template_related_theme_setup() {
		jardiwinery_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'jardiwinery'),
		...
		jardiwinery_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'jardiwinery'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'jardiwinery'),
			'w'		 => 370,
			'h'		 => 370
		));
		jardiwinery_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'jardiwinery'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'jardiwinery'),
			'w'		 => 370,
			'h'		 => 370
		));
		jardiwinery_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'jardiwinery'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'jardiwinery'),
			'w'		 => 370,
			'h'		 => 370
		));
...
// Template output
if ( !function_exists( 'jardiwinery_template_related_output' ) ) {
	function jardiwinery_template_related_output($post_options, $post_data) {
