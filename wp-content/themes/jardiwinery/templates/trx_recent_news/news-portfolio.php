...
if ( !function_exists( 'jardiwinery_template_news_portfolio_theme_setup' ) ) {
	add_action( 'jardiwinery_action_before_init_theme', 'jardiwinery_template_news_portfolio_theme_setup', 1 );
	function jardiwinery_template_news_portfolio_theme_setup() {
		jardiwinery_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'jardiwinery'),
...
// Template output
if ( !function_exists( 'jardiwinery_template_news_portfolio_output' ) ) {
	function jardiwinery_template_news_portfolio_output($post_options, $post_data) {
